...
class InvalidDevice extends StatelessWidget {
  InvalidDevice({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    controller.text = provider.deviceid!;
    return Scaffold(
      body: Container(
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Flexible(
                  child: CustomText(
                      text:
                          "Please contact system administrator to activate your new device",
                      color: pink)),
              SizedBox(
                height: 10,
              ),
              CustomText(
                text: "Your device id : ${provider.deviceid}",
                color: pink,
                weight: FontWeight.bold,
              ),
              TextField(
